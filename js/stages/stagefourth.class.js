...
export default class StageFourth {
    ...
    startDrawing(REF) {
      ...
      let barchart = barchartContainer.append('img').attr('src', '/vastuteq/assets/icons/barchart.svg').attr('width', 20);
      ...
      .style('flex-direction','column').style('height','42px').style('min-width','55px');
      let vpm = vpmContainer.attr('data-action-object', '/vastuteq/assets/icons/mvm.svg').append('img').attr('src', '/vastuteq/assets/icons/mvm.svg').attr('width', 20);
      ...
      .style('flex-direction','column').style('height','42px').style('min-width','55px');
      let mvm = mvmContainer.attr('data-action-object', '/vastuteq/assets/icons/vpm.svg').append('img').attr('src', '/vastuteq/assets/icons/vpm.svg').attr('width', 20);
