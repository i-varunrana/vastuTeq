export const DIRECTION_EIGHT = [
  {
    DISHARULINGPLANET : 'MERCURY',
    DISHAPALAKDIETY : 'KUBER',
    DISHAPALAKVEHICLE : 'WHITE HORSE',
    DISHAPALAKWEAPON : 'GADA',
    ASTHLAKSHMI : 'DHANLAKSHMI',
    COLOUR : 'GREEN',
    desc : 'North direction represent Money or Treasure and New opportunities.'},

    {DISHARULINGPLANET : 'JUPITER',
    DISHAPALAKDIETY : 'SHIVA / ISHAAN',
    DISHAPALAKVEHICLE : 'VRASHABH',
    DISHAPALAKWEAPON : 'TRISHUL',
    ASTHLAKSHMI : 'SANTAAN LAKSHAMI',
    COLOUR : 'YELLOW',
    desc : `It is the Zone of Wisdom, Meditation and Inspiration. 
    In Vastu, this Zone is ideal for Meditation.`},

    {DISHARULINGPLANET : 'SUN',
    DISHAPALAKDIETY : 'INDRA',
    DISHAPALAKVEHICLE :'',
    DISHAPALAKWEAPON : 'VAJRAYUDH',
    ASTHLAKSHMI : 'AISHWARYA LAKSHMI',
    COLOUR : 'WHITE',
    desc : `The energy generated by East Zone facilitates the Social Connectivity. 
    It is the ideal Zone for a Drawing Room.`},

    {DISHARULINGPLANET : 'VENUS',
    DISHAPALAKDIETY : 'AGNIDEV',
    DISHAPALAKVEHICLE : 'BAKRA',
    DISHAPALAKWEAPON : 'SHAKTI',
    ASTHLAKSHMI : 'DHANLAKSHMI',
    COLOUR : 'BROWN, MULTI COLOUR',
    desc : `South East Direction is responsible for good health and healthy finanace.`},

    {DISHARULINGPLANET : 'MARS',
    DISHAPALAKDIETY : 'YAM',
    DISHAPALAKVEHICLE : 'MAHISH',
    DISHAPALAKWEAPON : 'KAALPAASH',
    ASTHLAKSHMI : 'AADILAKSHMI',
    COLOUR : 'RED',
    desc : `Most importantly, this is the Zone of Fame, Recognition and Social Reputation.`},

    {DISHARULINGPLANET : 'RAHU',
    DISHAPALAKDIETY : 'NAIRUTI',
    DISHAPALAKVEHICLE : 'NAR (MANUSHAYA)',
    DISHAPALAKWEAPON : 'SWORD',
    ASTHLAKSHMI : 'DHAIRYA LAKSHAMI',
    COLOUR : 'SMOOKY',
    desc : `It is the direction of Skill, Marriage, Family Harmony, 
    Bonding, Stability in life and Relationships.`},

    {DISHARULINGPLANET : 'SATURN',
    DISHAPALAKDIETY : 'VARUN DEV',
    DISHAPALAKVEHICLE : 'CROCODILE (MAGAR)',
    DISHAPALAKWEAPON : 'PAASH',
    ASTHLAKSHMI : 'GAJ LAKSHMI',
    COLOUR : 'BLACK',
    desc : `The West direction is capable of giving success, glory, fame and fortune. 
    The energy of this Zone ensures that no action or effort made by you goes waste.`},

    {DISHARULINGPLANET : 'MOON',
    DISHAPALAKDIETY : 'VAAYU DEV',
    DISHAPALAKVEHICLE : 'HIRAN ( DEER)',
    DISHAPALAKWEAPON : 'ANKUSH',
    ASTHLAKSHMI : 'VIJAY LAKSHMI',
    COLOUR : 'WHITE',
    desc : `The North West is responsible for relationsships, friends, enemies and 
...
export const DIRECTION_SIXTEEN = [
  {ATTRIBUTE : 'MONEY AND OPPORTUNITIES',
    ELEMENT : 'WATER',
    ITCOVERS : `BHALLAT spread over 2 padas of Pishach Vithi & Manushya Vithi(N4)
    SOMA-spread over 2 padas of Pishach Vithi & Manushya Vithi (N5) 
    BHUDHAR-occupies Dev Vithi`
  },
  {ATTRIBUTE : `HEALTH AND IMMUNITY`,
    ELEMENT : `WATER`,
    ITCOVERS : `BHUJANG spread over 2 padas of Pishach Vithi & Manushya Vithi(N6)
  ...
  {ATTRIBUTE : 'CLARITY OF MIND',
    ELEMENT : 'WATER',
    ITCOVERS : `DITI spread over 1 pada of Pishach Vithi(N8) 
  ...
  {ATTRIBUTE : 'RECREATION AND FUN',
    ELEMENT : 'AIR',
    ITCOVERS : `PARJANYA - spread over 1 pada of Pishach Vithi(E2)
    APAVATSA occupies Manushya Vithi & ARYAMA in Dev Vithi ,
  ...
  {ATTRIBUTE : 'SOCIAL ASSOCIATION',
    ELEMENT : 'AIR',
    ITCOVERS : `INDRA- spread over 2 padas of Pishach Vithi & Manushya Vithi(E4),
    RAVI-spread over 2 padas of Pishach Vithi & Manushya Vithi(E5)
    ARYAMA in Dev Vithi`
  },
  {ATTRIBUTE : 'ANXIETY AND ANALYSIS',
    ELEMENT : 'AIR',
    ITCOVERS : `SATYA- spread over 2 padas of Pishach Vithi & Manushya Vithi(E6), 
  ...
  {ATTRIBUTE : 'CASH FLOW',
    ELEMENT : 'FIRE',
    ITCOVERS : `AKASH- spread over 1 pada of Pishach Vithi(E8)
    SAVITA occupies Manushya Vithi 
  ...
  {ATTRIBUTE : 'POWER AND CONFIDENCE',
    ELEMENT : 'FIRE',
    ITCOVERS : `PUSHA- spread over 1 pada of Pishach Vithi(S2,)
    SOSHA occupies Manushya Vithi
    VIVASVAN in Dev Vithi
  ...
  {ATTRIBUTE : 'EDUCATIONS AND SAVINGS',
    ELEMENT : 'SPACE',
    ITCOVERS : `DAUVARIK- spread over 1 pada of Pishach Vithi(W2)
    JAYA occupies Manushya Vithi
    MITRA in Dev Vithi
  ...
  {ATTRIBUTE : 'GAINS AND PROFITS',
    ELEMENT : 'SPACE',
    ITCOVERS : `PUSHPADANT- spread over 2 padas of Pishach Vithi & Manushya Vithi(W4), 
    VARUN- spread over 2 padas of Pishach Vithi & Manushya Vithi(W5), 
    MITRA in Dev Vithi`
  },
  {ATTRIBUTE : 'DEPRESSION',
    ELEMENT : 'SPACE',
    ITCOVERS : `ASURA- spread over 2 padas of Pishach Vithi & Manushya Vithi(W6),
  ...
  {ATTRIBUTE : 'SUPPORT AND BANKING',
    ELEMENT : 'EARTH',
    ITCOVERS : `PAPA YAKSHMA - spread over 1 pada of Pishach Vithi(W8), RUDRA occupies Manushya Vithi 
  ...
  {ATTRIBUTE : 'ATTRACTION AND SEX',
    ELEMENT :'WATER',
    ITCOVERS : `NAGA - spread over 1 pada of Pishach Vithi(N2), RAJYAKSHAMA occupies Manushya VithI
    BHUDHAR in Dev Vithi, 
